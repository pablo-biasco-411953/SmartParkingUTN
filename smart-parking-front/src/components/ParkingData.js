...
export const GRAPH_EDGES = [
    ...
    ["sur - auditorio", "civil"],
    ["sur - a.v.e.t.", "civil"],
    // Edificio Sur (Auditorio)
    ["sur - auditorio", "auditorio"],
    ["sur - ing. civil", "auditorio"],
    ["sur - a.v.e.t.", "auditorio"],
    // Edificio Sistemas (Central)
    ["inchaurrondo", "central"],
    ["benito posetto", "central"],
    ["biblioteca gallardo", "central"],
    // Biblioteca Gallardo
    ["biblioteca gallardo", "biblioteca"],
    ["planta piloto", "biblioteca"],
    // Edificio Soro
    ["edif. soro", "soro"],
    ["ing. sueldo", "soro"],
    // Edificio Ing. Sueldo
    ...
    ["benito posetto", "posetto"],
    ["inchaurrondo", "posetto"],
];
...
export const createBlankEditorState = () => ({
    buildings: [],
    greenAreas: [],
    trees: [],
    roadRoutes: [[]],
